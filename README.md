 ...
 * a github account
 * a github repository you **own**. The repository must include a folder called `records`
 ...
 * if the repository is part of an organisation, the OAuth app must request approval to the organisation owners (see [instructions for sending the request](https://docs.github.com/en/account-and-profile/setting-up-and-managing-your-github-user-account/managing-your-membership-in-organizations/requesting-organization-approval-for-oauth-apps)) and must be enabled by the organisation owner (see [instructions for organisation owners](https://docs.github.com/en/organizations/restricting-access-to-your-organizations-data/approving-oauth-apps-for-your-organization)).
